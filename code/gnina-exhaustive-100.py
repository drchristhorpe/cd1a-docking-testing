...
for pdb_code in pdb_codes:
    folder_name = f'experiments/gnina-exhaustive-100/{pdb_code}'
    if os.path.exists(folder_name):
        ...
        gnina_command = f'tools/gnina -r {cd1a_filename} -l {ligand_filename} --autobox_ligand {ligand_filename} -o {docked_filename} --log {log_filename} --exhaustiveness 100 --seed 0'
