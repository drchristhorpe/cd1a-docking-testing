...
for pdb_code in pdb_codes:
    folder_name = f'experiments/gnina-exhaustive-1/{pdb_code}'
    if os.path.exists(folder_name):
        ...
        gnina_command = f'tools/gnina -r {cd1a_filename} -l {ligand_filename} --autobox_ligand {ligand_filename} -o {docked_filename} --log {log_filename} --exhaustiveness 1 --seed 0'
